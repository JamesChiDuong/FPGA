...
void VBTN_Control::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addInitCb(&traceInit, __VlSymsp);
    traceRegister(tfp->spTrace());
}

void VBTN_Control::traceInit(void* userp, VerilatedVcd* tracep, uint32_t code) {
    ...
    tracep->scopeEscape(' ');
    VBTN_Control::traceInitTop(vlSymsp, tracep);
    tracep->scopeEscape('.');
}
...
void VBTN_Control::traceInitTop(void* userp, VerilatedVcd* tracep) {
    VBTN_Control__Syms* __restrict vlSymsp = static_cast<VBTN_Control__Syms*>(userp);
...
void VBTN_Control::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    VBTN_Control__Syms* __restrict vlSymsp = static_cast<VBTN_Control__Syms*>(userp);
    VBTN_Control* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VBTN_Control::traceRegister(VerilatedVcd* tracep) {
    // Body
    {
...
void VBTN_Control::traceFullTop0(void* userp, VerilatedVcd* tracep) {
    VBTN_Control__Syms* __restrict vlSymsp = static_cast<VBTN_Control__Syms*>(userp);
    VBTN_Control* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
...
void VBTN_Control::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    VBTN_Control__Syms* __restrict vlSymsp = static_cast<VBTN_Control__Syms*>(userp);
    VBTN_Control* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
