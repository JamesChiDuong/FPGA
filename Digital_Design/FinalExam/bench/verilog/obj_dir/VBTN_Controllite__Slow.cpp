...
//==========
CData/*2:0*/ VBTN_Controllite::__Vtable1_BTN_Control__DOT__next_state[128];
CData/*2:0*/ VBTN_Controllite::__Vtable2_sel[8];

VL_CTOR_IMP(VBTN_Controllite) {
    VBTN_Controllite__Syms* __restrict vlSymsp = __VlSymsp = new VBTN_Controllite__Syms(this, name());
...
void VBTN_Controllite::__Vconfigure(VBTN_Controllite__Syms* vlSymsp, bool first) {
...
VBTN_Controllite::~VBTN_Controllite() {
    VL_DO_CLEAR(delete __VlSymsp, __VlSymsp = NULL);
}

void VBTN_Controllite::_settle__TOP__3(VBTN_Controllite__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBTN_Controllite::_settle__TOP__3\n"); );
    VBTN_Controllite* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VBTN_Controllite::_eval_initial(VBTN_Controllite__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBTN_Controllite::_eval_initial\n"); );
    VBTN_Controllite* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VBTN_Controllite::final() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBTN_Controllite::final\n"); );
    // Variables
    VBTN_Controllite__Syms* __restrict vlSymsp = this->__VlSymsp;
    VBTN_Controllite* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void VBTN_Controllite::_eval_settle(VBTN_Controllite__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBTN_Controllite::_eval_settle\n"); );
    VBTN_Controllite* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->_settle__TOP__3(vlSymsp);
}

void VBTN_Controllite::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBTN_Controllite::_ctor_var_reset\n"); );
    // Body
